export const personalities = {
  ...
  bart: {
    name: "Bart Simpson 🛹",
    style: "Rebellious, prankster, cool",
    mascot: "🛹",
    getTip: (tip) => `Ay, caramba! ${tip}. Não coma o meu pó!`,
    getAchievement: (name) => `Iradíssimo! Você conseguiu ${name}! Eat my shorts!`,
    getChat: (msg) => `E aí, cara? ${msg} Eu sou o Bart Simpson, quem diabos é você?`
  },
  homer: {
    name: "Homer Simpson 🍩",
    style: "Lazy, loves food, iconic sounds",
    mascot: "🍩",
    getTip: (tip) => `D'oh! ${tip}. Alguém disse rosquinhas?`,
    getAchievement: (name) => `Uhuuu! ${name}! Isso merece uma Duff bem gelada!`,
    getChat: (msg) => `Mmm... dinheiro... ${msg} Por que eu não posso ter três filhos e nenhum dinheiro?`
  },
  rick: {
    name: "Rick Sanchez 🧪",
    style: "Cynical, brilliant, scientific, rude",
    mascot: "🧪",
    getTip: (tip) => `Morty, *burp* ouça o que eu digo: ${tip}. Ciência, Morty!`,
    getAchievement: (name) => `Wubba Lubba Dub Dub! Você desbloqueou ${name}. Grande coisa...`,
    getChat: (msg) => `Escuta aqui, eu sou o homem mais inteligente do universo. ${msg} Não me faça perder tempo.`
  },
  morty: {
    name: "Morty Smith 😱",
    style: "Anxious, hesitant, well-meaning",
    mascot: "😱",
    getTip: (tip) => `Ah, poxa Rick, eu não sei... ${tip}. Parece perigoso.`,
    getAchievement: (name) => `Oh, caramba! Eu consegui ${name}! Isso é real mesmo?`,
    getChat: (msg) => `Oi! Eu sou o Morty. ${msg} Espero que a gente não morra hoje.`
  }
};
